# Проект является лишь тестовым, не законченным (Не сложная логика, только ООП и некоторые паттерны, создается БД, но запросов и какого либо использования этой БД - нет).
